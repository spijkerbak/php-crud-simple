...
CREATE TABLE `Verkoper` (
	...
	CONSTRAINT `KamerFK` FOREIGN KEY (`KamerNr`) REFERENCES `Kamer` (`KamerNr`) ON UPDATE CASCADE
) ENGINE = InnoDB DEFAULT CHARSET = UTF8;
CREATE TABLE `Afzet` (
	`VerkNr` int,
	`ProdNr` int,
	...
	CONSTRAINT `AfzetProduct` FOREIGN KEY (`ProdNr`) REFERENCES `Product` (`ProdNr`) ON UPDATE CASCADE,
	CONSTRAINT `AfzetVerkoper` FOREIGN KEY (`VerkNr`) REFERENCES `Verkoper` (`VerkNr`) ON 
...
CREATE TABLE `Klant` (
	...
	CONSTRAINT `KlantVerkoper` FOREIGN KEY (`VerkNr`) REFERENCES `Verkoper` (`VerkNr`) ON UPDATE CASCADE ON DELETE RESTRICT
) ENGINE = InnoDB DEFAULT CHARSET = UTF8;
INSERT INTO `Kamer`
VALUES ('101', '', '100'),
	('102', '', '120'),
...
VALUES ('137', 'Holleman', '10', '2005', '101'),
...
INSERT INTO `Klant`
VALUES ('121', 'Werk aan de Winkel', '137', 'Rotterdam'),
